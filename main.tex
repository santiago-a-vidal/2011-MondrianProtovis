...
For this definition Protovis makes intensive use of functional programming [REF] through a declarative syntax. For example, to define a bar of \ct{height=100} and \ct{width=20} the following code must be used
\begin{lstlisting} 
...
\ab{What is the visual effect of this? Can you add a screenshot of the result in a web browser}
