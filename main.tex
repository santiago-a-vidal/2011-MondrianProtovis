...
The generation of HTML files with Protovis visualizations in Mondrian involves two main steps: (1) the creation of the dataset that contains information on which to base the graph, and (2) the description of the marks \ab{visual component?} to be drawn. The accomplishment of these steps is detailed in the following sections.
...
As Protovis uses a declarative syntax for each mark.
